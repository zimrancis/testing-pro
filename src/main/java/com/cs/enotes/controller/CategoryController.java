...
public class CategoryController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateCategory(@PathVariable ("id") Integer id, @RequestBody CategoryDTO updatedCategoryDTO)  throws Exception {

        updatedCategoryDTO.setId(id);
        CategoryDTO updatedCategory = categoryService.updateCategoryById(id, updatedCategoryDTO);
